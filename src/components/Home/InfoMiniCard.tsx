...
const InfoMiniCard = ({ icon, title, subtitle = "" }: InfoMiniCardProps) => (
  <div
    className="max-h-[55px] flex items-center p-[18px] w-[320px] bg-[var(--color-bg-black)] border border-[rgb(173,173,173)]
 rounded-[10px] shadow-[0_9px_16px_rgba(56,56,56,0.493)] my-[20px]"
  >
    <img src={icon} className="h-[48px] w-[48px] mr-[23%] rounded-[29px]" />
    <div className="">
